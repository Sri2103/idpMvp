...
import (
	...
	"idp_mvp/pkg/api/generated/api-gateway/client"
...
func makeClient(cmd *cobra.Command, _ []string) (*client.APIGateway, error) {
...
func makeGroupOfOperationsOperationsCmd() (*cobra.Command, error) {
	...
	sub0, err := makeOperationOperationsGetHealthzCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub0)

	sub1, err := makeOperationOperationsGetReadyCmd()
	if err != nil {
		return nil, err
	}
