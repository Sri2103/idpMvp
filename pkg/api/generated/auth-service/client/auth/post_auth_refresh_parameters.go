...
func (o *PostAuthRefreshParams) WithRequest(request map[string]string) *PostAuthRefreshParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post auth refresh params
func (o *PostAuthRefreshParams) SetRequest(request map[string]string) {
	o.Request = request
}
