...
import (
	...
	"idp_mvp/pkg/api/generated/auth-service/client"
...
func makeClient(cmd *cobra.Command, _ []string) (*client.AuthService, error) {
...
func MakeRootCmd() (*cobra.Command, error) {
	...
	c0, err := makeGroupOfOperationsAuthCmd()
	if err != nil {
		return nil, err
	}
	rootCmd.AddCommand(c0)
	c1, err := makeGroupOfOperationsHealthCmd()
	if err != nil {
		return nil, err
	}
...
} // makeGroupOfOperationsAuthCmd returns a parent command to handle all operations with tag "auth"
func makeGroupOfOperationsAuthCmd() (*cobra.Command, error) {
	parent := &cobra.Command{
		Use:  "auth",
		Long: ``,
	}

	sub0, err := makeOperationAuthGetAuthMeCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub0)

	sub1, err := makeOperationAuthPostAuthChangePasswordCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub1)

	sub2, err := makeOperationAuthPostAuthForgotPasswordCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub2)

	sub3, err := makeOperationAuthPostAuthLoginCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub3)

	sub4, err := makeOperationAuthPostAuthLogoutCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub4)

	sub5, err := makeOperationAuthPostAuthRefreshCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub5)

	sub6, err := makeOperationAuthPostAuthRegisterCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub6)

	sub7, err := makeOperationAuthPostAuthResetPasswordCmd()
	if err != nil {
		return nil, err
	}
...
func makeGroupOfOperationsHealthCmd() (*cobra.Command, error) {
	...
	sub0, err := makeOperationHealthGetHealthzCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub0)
